                      ...
                      <div className="space-y-4">
                        <div className="grid gap-3">
                          ...
                          <div className="flex items-start gap-3 p-3 bg-purple-50 dark:bg-purple-900/20 rounded-lg">
                            <MessagesSquare className="h-5 w-5 text-purple-600 mt-0.5 flex-shrink-0" />
                            <div>
                              <p className="font-semibold text-foreground">Lab 3: Set Up a Local Chatbot</p>
                              <p className="text-sm text-muted-foreground">Build and run your own chatbot powered by Kimi API</p>
                            </div>
                          </div>
                          <div className="flex items-start gap-3 p-3 bg-fuchsia-50 dark:bg-fuchsia-900/20 rounded-lg">
                            <GitBranch className="h-5 w-5 text-fuchsia-600 mt-0.5 flex-shrink-0" />
                            <div>
                              <p className="font-semibold text-foreground">Lab 4: Explore GitHub Projects</p>
                              <p className="text-sm text-muted-foreground">Discover and leverage open-source repositories for your goals</p>
                            </div>
                          </div>
                        </div>
                      </div>
